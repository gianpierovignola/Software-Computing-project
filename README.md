...
The aim of this work is to analyze simulated montecarlo data (Signal and Background) of a decaying of the charmed Λ<sub>c</sub></sup>+</sup> baryon using the ROOT TMVA tool. the [main code](https://github.com/gianpierovignola/project/blob/master/01_TMVA_Program.ipynb) is written in python using Python-C ++ bindings, called PyROOT. <br>
